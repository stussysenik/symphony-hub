...
polling:
  interval_ms: 5000
workspace:
  root: /Users/s3nik/Desktop/symphony-setup/workspaces/v0-ipod
hooks:
  after_create: |
    git clone --depth 1 https://github.com/stussysenik/v0-ipod.git .
  ...
  before_remove: |
    ...
    echo "Cleaning up workspace for v0-ipod"
agent:
...
You are working on a Linear ticket `{{ issue.identifier }}` for the **v0-ipod** project.
...
Repository: https://github.com/stussysenik/v0-ipod.git
Project: v0-ipod
Workspace: /Users/s3nik/Desktop/symphony-setup/workspaces/v0-ipod
